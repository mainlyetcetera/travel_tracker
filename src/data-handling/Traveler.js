...
export default class Traveler {
  ...
  spentOnTrip(trip, list) {
    const destination = trip.findCorrespondingDestination(list);
  ...
  spentInTotal(listOfDestinations) {
    const tripsTotal = this.spentOnTrips(listOfDestinations);
